...
# from models import *
from models.caraseguper import CaraSegUPer
import os
...
def main():
    ...
    for i, pack in tqdm.tqdm(enumerate(test_loader, start=1)):
        ...
        if dev == "cpu":
            ...
            image = image.cuda()
        if config['train']['multi_loss'] == True:
        ...
        for j in range(3):
            ...
            if j == 1:
                res1, res2, res3, res4 = model(torch.flip(image, dims=(2, )))
                out_v = res1
            ...
            if j == 2:
                res1, res2, res3, res4 = model(torch.flip(image, dims=(3, )))
                out_h = res1
