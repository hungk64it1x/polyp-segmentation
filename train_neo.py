...
from utilizes.dataloader import get_neo_loader
from utilizes.augment_neo import Augmenter
...
from auxiliary import losses as losses ##v1
# from aux import smp_losses as losses
from tools.trainer_neo import *
...
def main():
    ...
    if type(train_data_path) != list:
        ...
        for i in train_data_path:
            ...
            train_label_paths.extend(glob(os.path.join(i, "labels", "*")))
